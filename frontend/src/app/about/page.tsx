            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 bg-gray-50">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Placeholder for detailed system architecture diagram
                </p>
                <div className="bg-white rounded p-6 max-w-2xl mx-auto text-left text-sm">
                  <p className="font-semibold mb-3">Flowchart should illustrate:</p>
                  <ol className="space-y-2 text-gray-700">
                    <li>1. User selects location & parameters on frontend</li>
                    <li>2. POST request to /api/v1/recommend/business-locations</li>
                    <li>3. Backend validates search area within San Diego boundary</li>
                    <li>4. Spatial join to identify Census block groups in radius</li>
                    <li>5. Parallel API calls: Census (demographics) + Google Places (competitors)</li>
                    <li>6. Calculate 7 scoring metrics per location</li>
                    <li>7. Select top 5 competitors per location</li>
                    <li>8. Fetch competitor reviews from Google Places Details API</li>
                    <li>9. Send reviews to Groq LLM for AI analysis</li>
                    <li>10. Rank locations by opportunity score, return top 3</li>
                    <li>11. Frontend displays results with charts & AI insights</li>
                  </ol>
                </div>
                <p className="text-sm text-gray-500 mt-4">
                  Use tools like Lucidchart, draw.io, or Excalidraw to create the diagram, 
                  then replace this placeholder with an embedded image
                </p>
              </div>
            </div>
          </section>
